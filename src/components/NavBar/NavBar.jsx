...
const pages = ['TopOffers', 'SearchOffers', 'Refrences', 'AboutUs', 'OurTeams'];
export const NavBar = () => {
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu}>
                  <Typography variant="body1" sx={{ color: "141B2D", fontFamily: "OpenSans" }} textAlign="center">{page}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
